...
function App() {
  ...
  const [weatherIcon, setWeatherIcon] = useState(
    `${process.env.REACT_APP_ICON_URL}10@2x.png`
  );
          ...
          <div className="flex flex-col items-center justify-center h-full">
            ...
            >
              ...
              <button type="submit" className="z-10">
                <i
                  className="fa fa-search text-white m1-10 border-1 my-auto z-10 cursor-pointer p-3"
                  aria-hidden="true"
                  onClick={() => {
        ...
        <div className="w-2/4 p-5">
          ...
          <div className="flex flex-col my-10">
            {weatherData.length === 0 ? (
              ...
              <>
                <h1 className="text-5x1 text-gray-800 mt-auto mb-4">Today</h1>
